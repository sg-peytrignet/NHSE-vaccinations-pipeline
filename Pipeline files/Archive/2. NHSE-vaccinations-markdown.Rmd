...
chart.data <- filter(age_dose_summary,ageband_bis!="allages"&region=="Total") %>%
...
```{r region, echo=FALSE, message=FALSE, warning=FALSE,fig.width=9,fig.height=6}

```

## COVID-19 vaccinations by ethnicity

```{r ethn, echo=FALSE, message=FALSE, warning=FALSE,fig.width=9,fig.height=6}
